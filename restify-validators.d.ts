...
declare const nodejs_validators: nodejs_validators.nodejs_validators;
...
declare module nodejs_validators {
    export interface nodejs_validators {
        ...
        mk_valid_body_mw(json_schema: JsonSchema, to_res?: boolean);
        mk_valid_body_mw_ignore(json_schema: JsonSchema, ignore: Array<string>);
